...
func (h *ProductHandler) CreateProduct(c *fiber.Ctx) error {
	...
	if err := c.BodyParser(&req); err != nil {
		logging.LogWarn("create product failed: body parse", "error", err)
		return HandleError(c, service.ErrInvalidInput)
	}

	if err := validator.Validate.Struct(req); err != nil {
		logging.LogWarn("create product failed: validation error", "error", err, "name", req.Name)
	...
	if err != nil {
		logging.LogWarn("create product failed: service error", "error", err, "name", req.Name)
		return HandleError(c, err)
	}

	logging.LogInfo("product created successfully", "productID", product.ID, "name", req.Name)
...
func (h *ProductHandler) GetProduct(c *fiber.Ctx) error {
	...
	if err != nil {
		logging.LogWarn("get product failed: invalid product ID", "error", err, "productIDParam", idParam)
		return HandleError(c, service.ErrInvalidInput)
	}

	product, err := h.productSvc.GetProduct(uint(productID))
	if err != nil {
		logging.LogWarn("get product failed: service error", "error", err, "productID", productID)
		return HandleError(c, err)
	}

	logging.LogInfo("product retrieved successfully", "productID", productID)
...
func (h *ProductHandler) UpdateProduct(c *fiber.Ctx) error {
	...
	productID, err := strconv.ParseUint(idParam, 10, 64)
	if err != nil {
		logging.LogWarn("update product failed: invalid product ID", "error", err)
		return HandleError(c, service.ErrInvalidInput)
	}

	var req dto.UpdateProductRequest
	if err := c.BodyParser(&req); err != nil {
		logging.LogWarn("update product failed: body parse", "error", err, "productID", productID)
		return HandleError(c, service.ErrInvalidInput)
	}

	if err := validator.Validate.Struct(req); err != nil {
		logging.LogWarn("update product failed: validation error", "error", err, "productID", productID)
		return c.Status(400).JSON(fiber.Map{
			"errors": validator.FormatErrors(err),
		})
	}
	...
	if err := h.productSvc.UpdateProduct(uint(productID), req); err != nil {
		logging.LogWarn("update product failed: service error", "error", err, "productID", productID)
		return HandleError(c, err)
	}

	logging.LogInfo("product updated successfully", "productID", productID)
...
func (h *ProductHandler) DeleteProduct(c *fiber.Ctx) error {
	...
	productID, err := strconv.ParseUint(idParam, 10, 64)
	if err != nil {
		logging.LogWarn("delete product failed: invalid product ID", "error", err, "productIDParam", idParam)
		return HandleError(c, service.ErrInvalidInput)
	}

	if err := h.productSvc.DeleteProduct(uint(productID)); err != nil {
		logging.LogWarn("delete product failed: service error", "error", err, "productID", productID)
		return HandleError(c, err)
	}

	logging.LogInfo("product deleted successfully", "productID", productID)
...
func (h *ProductHandler) ListProducts(c *fiber.Ctx) error {
	...
	if err != nil {
		logging.LogWarn("list products failed: service error", "error", err)
		return HandleError(c, err)
	}

	logging.LogInfo("products listed successfully", "count", len(products))
